...
Dữ liệu được sử dụng trong dự án này là bộ **Coffee Shop Sales/Inventory/Staff dataset** (nguồn: Kaggle), bao gồm 8 bảng dữ liệu có quan hệ với nhau (multi-table relational structure):
